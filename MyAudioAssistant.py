...
def run_alexa():
    while True:
        ...
        elif 'make qr code' in command:
            talk("Creating qr code! Please wait for a min")
            img = qrcode.make("https://github.com/SankalpDangwal16/Myprojects")
            img.save("qr.jpg")
            talk('QR Code created please check your folder')
            print(img)
